(function() {
	...
	var ParticleNetwork = function(parent) {
		this.options = {
			velocity: 1, // the higher the faster 速度
			density: 15000, // the lower the denser 密度
			netLineDistance: 200,
			netLineColor: '#929292',// 网的颜色
			particleColors: ['#aaa'] // ['#6D4E5C', '#aaa', '#FFC458' ] 粒子颜色
		};
		this.canvas = parent.canvas;
		this.ctx = parent.ctx;
